			...
			<aside id="layout-menu"
				...
				<div class="app-brand demo">
					<a href="/dreams/mypage" class="app-brand-link"> <span
						class="app-brand-text demo menu-text fw-bolder ms-2">My
							page</span>
			...
			<div class="content-wrapper">
				...
				<div class="container-xxl flex-grow-1 container-p-y">
					<h4 class="fw-bold py-3 mb-4">
						<span class="text-muted fw-light"> </span>주문 상세
					</h4>
													...
													<div class="panel-body">
														<div class="myaccount-info-wrapper">
															...
															<table class="table-box" border="0">
																<thead>
																	<tr>
																		<th class="order-date-status" colspan="2">받는 사람
																			정보</th>
																	</tr>
																</thead>
																<tbody>
																	...
																	<tr>
																		<td>우편번호</td>
																		<td>${order.memberPcode}</td>
																	</tr>
																	<tr>
																		<td>주소</td>
																		<td>${order.memberAddress1}
																			${order.memberAddress2}</td>
																	</tr>

																	<tr>
																		<td>배송 메시지</td>
																		<td>${order.deliverMsg}</td>
																	</tr>
																</tbody>
															</table>
