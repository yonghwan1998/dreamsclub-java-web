   ...
   <div class="communityDetail">
      ...
      <div class="communityDetailContainer">
         <div class="headwrap">
            ...
            <div class="writer" style="width: 15%; text-align: right;">작성자
               : 드림즈 관리자</div>
            <div class="writeDate" style="width: 15%; text-align: right;">
               작성일자 :
               <c:out value="${pageInfo.noticeDate }" />
            </div>
         </div>
      ...
      <div class="communityDetailBtn">
         ...
         <c:if test="${member.memberStatus == 9}">
            <a href="/dreams/notice/modify?noticeNo=${pageInfo.noticeNo}"
               role="button" id="modify_btn">수정하기</a>
            <a href="/dreams/notice/delete?noticeNo=${pageInfo.noticeNo}"
               role="button" id="delete_btn">삭제하기</a>
         </c:if>
      </div>
      ...
      <form id="infoForm" action="/dreams/notice/detail" method="get">
         <input type="hidden" id="noticeNo" name="noticeNo"
            value='<c:out value="${pageInfo.noticeNo}"/>'>
      </form>
