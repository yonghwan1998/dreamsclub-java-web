...
<%@page import="xyz.dreams.dao.MemberDAO"%>
<%@page import="xyz.dreams.dto.MemberDTO"%>
...
<%
	...
	//아이디를 전달받아 MEMBER 테이블에 저장된 회원정보를 검색하여 DTO 객체로 반환하는
	//DAO 클래스의 메소드 호출
	// 객체호출할수없대
...
<%-- <result>
	<% if(Member!=null) {//아이디로 검색된 회원정보가 있는 경우 - 아이디 중복(아이디 사용 불가능) %>
